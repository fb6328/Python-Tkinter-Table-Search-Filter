...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `member` (firstname, lastname, address, age) VALUES('Julius', 'Kuta', 'Kampala', '20')")
        cursor.execute("INSERT INTO `member` (firstname, lastname, address, age) VALUES('Tisa', 'Matano', 'Mombasa', '25')")
        cursor.execute("INSERT INTO `member` (firstname, lastname, address, age) VALUES('Ole', 'Maasai', 'Serengeti', '18')")
        cursor.execute("INSERT INTO `member` (firstname, lastname, address, age) VALUES('Bim', 'John', 'Cairo', '55')")
        cursor.execute("INSERT INTO `member` (firstname, lastname, address, age) VALUES('Jay', 'Shem', 'Addis', '22')")
        cursor.execute("INSERT INTO `member` (firstname, lastname, address, age) VALUES('Jean', 'Maiyo', 'Kigali', '30')")
        conn.commit()
